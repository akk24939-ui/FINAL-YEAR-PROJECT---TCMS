...
class LimitsHistory(Base):
    ...
    # NOTE: relationship removed — consumer_id FK points to users.id,
    # not consumers.id, so a simple back-ref cannot be auto-resolved.
    # Join manually in queries where needed.
